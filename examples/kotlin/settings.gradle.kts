...
// erste ist `http-client`. `dependencyResolutionManagement` zentralisiert
// die Paket-Quelle für alle Module — Netz ist ohnehin Voraussetzung
// (NuGet-/Maven-Paketbezug, ADR-0090 Festlegung 5), `make gates` bleibt davon
// unberührt.
