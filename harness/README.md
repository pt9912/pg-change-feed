...
| `make coverage-gate` | Go-Test-Coverage über `./internal/...`+`./cmd/...` gegen `THRESHOLD` — bootstrap-aware Gate, Rampe Einstieg 35 % → Endstufe 80 %; geltende Stufe in [`harness/mk/coverage.mk`](mk/coverage.mk) | [`ADR-0054`](../docs/plan/adr/0054-coverage-gate-und-benchmark-infrastruktur.md) · [`harness/sensors/coverage-gate.md`](sensors/coverage-gate.md) · seit slice-049 |
