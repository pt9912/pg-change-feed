...
| [`make coverage-gate`](sensors/coverage-gate.md) | Go-Test-Coverage über `./internal/...`+`./cmd/...` gegen `THRESHOLD` — bootstrap-aware Gate, Einstiegsstufe 35 %, Endstufe 80 % | [`ADR-0054`](../docs/plan/adr/0054-coverage-gate-und-benchmark-infrastruktur.md) · [`harness/sensors/coverage-gate.md`](sensors/coverage-gate.md) · seit slice-049 |
