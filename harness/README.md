...
| `make generated-sync` | Der committete Protobuf-/gRPC-Code ist byte-gleich der Ausgabe des **gepinnten** Generators (Dockerfile-Stufe `proto`) aus den committeten `.proto`-Quellen; erzeugt wird in ein Temp-Verzeichnis, der Arbeitsbaum bleibt unberührt | [`harness/sensors/generated-sync.md`](sensors/generated-sync.md) · seit slice-090 |
