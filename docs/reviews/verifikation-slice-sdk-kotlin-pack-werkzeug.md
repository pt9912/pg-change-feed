...
| 5 | `harness/README.md` §Werkzeuge, Bindung ADR-0109 | Real gelesen (`grep -n "sdk-pack-kotlin" harness/README.md`): Zeile 158, vollständige Zeile analog `sdk-pack-csharp`/`sdk-pack-python`, endet mit `kein Gate, [`ADR-0109`](../docs/plan/adr/0109-kotlin-github-packages-drittes-sdk-package.md) Festlegung 5 · seit slice-sdk-kotlin-pack-werkzeug` | **Bestätigt** |
