...
Changes. Das Lastenheft nimmt genau das in Kauf (LH-QA-REL-004) und
...
| B — At-Most-Once | Keine Duplikate | Verluste bei Crash — verletzt LH-QA-REL-001 |
...
- Positiv: Das Modell und die Schnittstellen erlauben idempotente
  Verarbeitung (LH-QA-REL-004); Wiederholung ist kein Fehlerfall, sondern
  Betrieb.
...
- Folgepflicht: Erneutes Lesen desselben Bereichs liefert dieselben Changes
  (LH-FA-REA-005) — Grundlage für Consumer-Deduplizierung.
...
permanent — die Semantikwahl trägt die Vertragszusage LH-QA-REL-004.
