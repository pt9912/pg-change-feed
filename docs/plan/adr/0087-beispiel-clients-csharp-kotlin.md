...
| 2026-09-17 | Digest-Korrektur — `eclipse-temurin:21-jdk`-Zeile der Digest-Pinning-Tabelle (Zeile 254) per Folge-ADR ersetzt, 63- statt 64-stelliger Transkriptionsfehler behoben (`ADR-0093`, Anlass `docs/reviews/review-slice-099.md` F-1) | `aa22937` <!-- d-check:status-provenance --> |
