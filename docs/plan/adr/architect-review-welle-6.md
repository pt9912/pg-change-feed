...
**Eingang:** [`docs/plan/planning/welle-6.md`](../planning/welle-6.md) §1–§6,
...
2. **Beobachtungs-Register — Lese-Schritt (Modul 6, Closure-Schritt
   ...
   [`slice-023`](../planning/open/slice-023-rollen-spezifische-dsn-verdrahtung.md)
...
| `BEO-PGC/rollen-verdrahtung` (3×) — Ausgang | **geplant** → [`slice-023`](../planning/open/slice-023-rollen-spezifische-dsn-verdrahtung.md) (Skelett angelegt) |
...
| Folge-Slice-Skelett angelegt | [`slice-023`](../planning/open/slice-023-rollen-spezifische-dsn-verdrahtung.md) |
