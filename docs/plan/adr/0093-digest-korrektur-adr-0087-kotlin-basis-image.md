...
`docs/reviews/review-slice-099.md`, Commit `a65bf29`)
...
Der Reviewer von `slice-099` hat beim Prüfen von `examples/kotlin/Dockerfile`
gegen `ADR-0087`s Digest-Pinning-Tabelle (§Entscheidung, Festlegung 3,
Zeile 254) eine Diskrepanz gefunden
(`docs/reviews/review-slice-099.md`, Finding F-1, Commit `a65bf29`): der dort
