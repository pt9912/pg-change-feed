Zustand: verkörpert — Ausgang: **verkörpert** → geschärfte Regel als
Pflicht-Zeile im Implementer-Workflow, Zielort
`.claude/commands/implement-slice.md` (Pre-completion-Checkliste Schritt 18:
...
Stabilität des Musters, tragen aber keinen eigenen Zähler-Beitrag (ein
