...
- [ ] Consumer-Use-Cases am Inbound-Port (Registrierung/ACK/Entfernung)
...
|---|---|---|
| `internal/adapters/driven/postgresstorage/` (consumer-Tabellen) | update | DDL-Erweiterung je [`SPEC-001`](../../../../spec/pflichtenheft.md) — consumer/consumer_position über d-migrate-Rollout-Änderung |
| `internal/application/usecase/{acknowledge,register,reset}/*.go` | neu | Services je [`ADR-0028`](../../../../docs/plan/adr/README.md) |
