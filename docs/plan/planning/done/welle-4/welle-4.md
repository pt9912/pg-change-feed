...
vervollständigt: Health-Endpoint (per Heartbeat-Pattern, der Architect-Review
zu `slice-011` liegt bereits vor),
...
Ergebnis: [`welle-4-results.md`](welle-4-results.md)
