...
`done/welle-2/welle-2.md` tragen in §7 noch `<Zeiger auf welle-<NN>-results.md …>`,
...
mitdenken (Ausnahme für Vorgänge vor ihrer Einführung) oder auf die
Closure-Form zielen statt auf den Bestand.
